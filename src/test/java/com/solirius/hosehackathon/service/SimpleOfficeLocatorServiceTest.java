...
class SimpleOfficeLocatorServiceTest {
    ...
    void getOffice_Normal_ReturnOffice() {
        ...
        Office office1 = new Office(-0.285419, 50.828782, "Adur Estuary", false, true, false, true, true, true, true, false);
        officeFindAll.add(office1);
        Office office2 = new Office(-7.743797,54.218553, "Aghatirourke", false, true, false, true, true, true, true, false);
        officeFindAll.add(office2);
        Office office3 = new Office(-5.116096,55.25298, "Adur Estuary", false, true, false, true, true, true, true, false);
